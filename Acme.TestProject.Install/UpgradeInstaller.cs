...
namespace Acme.TestProject.Install
{
    ...
    internal class UpgradeInstaller
    {
        ...
        internal const string DEFAULT_NAMESPACE = "Acme.TestProject.Install";
        internal const string MODELKEY = "7413288b-2c2b-4276-a4bb-7a8fc35d767e";
        private GeneratedVersion _previousVersion = null;
        private static GeneratedVersion _upgradeToVersion = new GeneratedVersion(0, 0, 0, 0, 3);
