...
{
	#region TestProjectEntitiesExtensions

	/// <summary>
	/// Extension methods for this library
	/// </summary>
	[System.CodeDom.Compiler.GeneratedCode("nHydrate", "7.0.0")]
	public static partial class TestProjectEntitiesExtensions
	{
		...
		/// </summary>
		public static System.Type GetFieldType(this Acme.TestProject.EFDAL.TestProjectEntities context, Enum field)
		{
			if (field is Acme.TestProject.EFDAL.Entity.Customer.FieldNameConstants)
				return Acme.TestProject.EFDAL.Entity.Customer.GetFieldType((Acme.TestProject.EFDAL.Entity.Customer.FieldNameConstants)field);
			if (field is Acme.TestProject.EFDAL.Entity.Order.FieldNameConstants)
				return Acme.TestProject.EFDAL.Entity.Order.GetFieldType((Acme.TestProject.EFDAL.Entity.Order.FieldNameConstants)field);
		...
		public static System.Collections.ObjectModel.ObservableCollection<T> AsObservable<T>(this System.Collections.Generic.IEnumerable<T> list)
			where T : Acme.TestProject.EFDAL.IReadOnlyBusinessObject
		{
		...
		public static Acme.TestProject.EFDAL.IMetadata GetMetaData(this Acme.TestProject.EFDAL.IReadOnlyBusinessObject entity)
		{
			...
			return Activator.CreateInstance(t) as Acme.TestProject.EFDAL.IMetadata;
		}
